...
class Model_slide_sub extends CI_Model {

	private $type = 'slide_sub';
	...
	{ 
		...
		$query = $this->db->where('slide_Status', 1)->where('slide_Type','sub')->order_by('slide_Sort', 'ASC')->get('tb_slide')->result_array();
		$data = $query;
