...
class Model_home extends CI_Model {
	...
	{ 
		if($home){
			...
			$data['homedata'] = $this->db->where('news_Type', $this->type)->where('news_Status', 1)->order_by('news_Sort','ASC')->get('tb_news')->result_array();
	...
	{ 
		...
		$query = $this->db->where('news_Type',$this->type)->where('news_ID',$id)->get('tb_news');
	...
	{ 
		...
		// 		$handle->process('assets/upload/news/gallery');
		// 	}
