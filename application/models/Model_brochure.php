...
class Model_brochure extends CI_Model {
	
	private $type = 'brochure';
		...
		foreach ($query->result_array() as $row){
			...
			foreach ($query2->result_array() as $row3){
				...
				$data["news"]["news_file_TH"][] = array(
					...
					'file_Title_TH' => $row3["file_Title_TH"],
					'file_name_TH' => $row3["file_name_TH"],
	...
	{ 
		...
		$files2 = array();
		foreach (@$_FILES['news_file_TH'] as $k2 => $l2)
		{
			foreach ($l2 as $i2 => $v2)
			{
