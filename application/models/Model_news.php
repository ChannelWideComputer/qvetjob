...
class Model_news extends CI_Model {
	...
	{ 
		if($home){
			...
			$this->db->start_cache();	
			//$this->db->join('tb_news_gallery', 'tb_news_gallery.news_ID = tb_news.news_ID', 'left');		
			...
			/*
			$query2 = $this->db->where('news_ID', $data['news']["news_ID"]['0'])->order_by('gallery_Sort', 'ASC')->get('tb_news_gallery');
	...
	{ 
		...
		foreach ($query->result_array() as $row){
			...
			$data["news"] = array(
				...
				'photographer_TH' => $row["photographer_TH"],
				'photographer_EN' => $row["photographer_EN"],
				'Stylist_TH' => $row["Stylist_TH"],
				'Stylist_EN' => $row["Stylist_EN"],
	...
	{ 
		...
		$data = array(
			...
			'photographer_TH' => $_POST["photographer_TH"],
			'photographer_EN' => $_POST["photographer_EN"],
			'Stylist_TH' => $_POST["Stylist_TH"],
			'Stylist_EN' => $_POST["Stylist_EN"],
			'location_TH' => $_POST["location_TH"],
