      ...
      <table class="table table-striped table-bordered table-hover" style="margin-top:10px;" width="100%">
       <thead>
        <tr>
          ...
          <td width="25%" align="center">Name - Surname</td>
          <td width="20%" align="center">Position</td>
          <td width="15%" align="center">Date</td>
          <td width="5%" align="center">Resume</td>
      ...
      <tbody>
        ...
        foreach ($job as $row)
        {
          ...
          <tr> 
           ...
           <td align="center"><input class="ChkBox" type="checkbox" name="checkboxlist"  value="<?php echo $row["re_ID"];?>"></td> 
           <td align="left"> <?php echo $row['re_name'];?></td>
           <td align="center"> <?php echo $row['category_Name_TH'];?></td>
           <td align="center"><?php echo DateThai_timestame($row["re_Date"]);?></td>
           <td align="center">
            <a href=<?php echo base_url("assets/upload/resume/".$row["re_file"]);?> class="btn btn-success" target=_blank style="margin-top:5px">
              <span class="glyphicon glyphicon-save"></span> Download
            </a>
          </td>
          <td align="center"><a href="#Modal_delete" class="delete" id="<?php echo $row['re_ID'];?>"><i class="fa fa-trash-o" style="color:#333;font-size:1.4em"></i></a></td>
        </tr>
  ...
  $(document).ready(function(){ 
    ...
    $('.aaaa').click(function(){
      ...
      var ID = $(this).attr("id");
        //alert(ID);      
        $.ajax({
          url: '<?php echo base_url('cwcontrol/'.$page.'/detail');?>',
          type: 'post',
          data: {id:ID},
          //dataType:'json',
          success:function(data){
            ...
            //alert(data);              
              //location.reload();
              $('#show2').html(data);
              //$('#show2').load(<?php //echo base_url('cwcontrol/pages/register/member_detail');?>,{ID:re_ID});
