...
?>    
 ...
 <td align="center"><input class="ChkBox" type="checkbox" name="checkboxlist"  value="<?php echo $row["category_ID"];?>"></td> 
 <td align="center"><?php echo $row["category_Name_TH"]?></td>
 <td align="center"><?php echo DateThai_timestame($row["category_Date"]);?></td>
 <td align="center">
 <select class="form-control Sort" id="<?php echo $row['category_ID'];?>">
     <?php
		
		$query2 = $this->db->where('type', 'service')->get('tb_category');
	...
	?>
<option value="<?php echo $t;?>" <?php if($row["category_Sort"] == $t){ echo "selected"; }?>><?php echo $t;?></option>
<?php
		}
 ...
 <td align="center">
    ...
    <input type="checkbox" class="status" data-size="mini" data-on-color="success" id="<?php echo $row["category_ID"];?>" <?php if($row["category_Status"] == 1){ echo "checked";}?>>
    

 </td>
 <td align="center"><a href="<?php echo $page_url;?>?type=edit&id=<?php echo $row["category_ID"]?>"><i class="fa fa-cog" style="color:#333;font-size:1.4em"></i></a></td>
 <td align="center"><a href="#" class="delete" id="<?php echo $row['category_ID'];?>"><i class="fa fa-trash-o" style="color:#333;font-size:1.4em"></i></a></td>
 </tr>
