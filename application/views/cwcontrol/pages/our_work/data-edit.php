...
#list1 li{
    ...
    /*.placeHolder{
      ...
      <!-- <div class="col-lg-6">  
       <div class="form-group">
        ...
        <input type="text" class="form-control" name="news_Des_TH" required value="<?php echo $news["news_Des_TH"]?>">
      </div> 
    </div>  -->
    ...
    <!-- <div class="col-lg-6">  
     <div class="form-group">
      ...
      <input type="text" class="form-control" name="news_Des_EN" required value="<?php echo $news["news_Des_EN"]?>">
    </div> 
  </div>  -->
  ...
  <div class="col-lg-12">  
    <div class="form-group">
     <label>รูปภาพปก ขนาด 384px x 513px</label>
  ...
  if(isset($news["news_gallery"])){
...

   {
...

    {
     ...
     type: "image",
     file: "<?php echo asset_url()?>upload/news/gallery/full_<?php echo $row_gallery["gallery_Images"]?>",
