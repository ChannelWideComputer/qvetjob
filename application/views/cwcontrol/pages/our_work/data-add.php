            ...
            <div class="row">
              ...
              <!-- <div class="col-lg-6">  
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="news_Des_TH" required>
                </div>
              </div>  -->
              ...
              <!-- <div class="col-lg-6">  
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="news_Des_EN" required>
                </div>
              </div>  -->
...
<script>
  $('#File_TH').filer({
   ...
   captions: {
     ...
     errors: {
      filesType: 'เฉพาะไฟล์ pdf เท่านั้น',
