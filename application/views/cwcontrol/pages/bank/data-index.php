							...
							<table class="table table-striped table-bordered table-hover" style="margin-top:10px;" width="100%">
								<thead>
									<tr>
										...
										<td width="25%" align="center">ชื่อบัญชี</td>
										<td width="25%" align="center">ชื่อธนาคาร</td>
									...
									if(!isset($bank)){
										...
										foreach ($bank as $row)
										{
											...
											<tr> 
												...
												<td align="center"><input class="ChkBox" type="checkbox" name="checkboxlist"  value="<?php echo $row["bank_ID"];?>"></td> 
												<td align="center"><?php echo $row["bank_accout"]?></td>
												<td align="center"><?php echo $row["bank_name"]?></td>

												<td align="center"><?php echo DateThai_timestame($row["bank_date"]);?></td>

												<td align="center">
													<select class="form-control Sort" id="<?php echo $row['bank_ID'];?>">
														<?php
														
														$query2 = $this->db->where('bank_type2',$row['bank_type2'])->get('tb_bank');	
														$t = 0;
														foreach ($query2->result_array() as $row2)
														{
															...
															?>
															<option value="<?php echo $t;?>" <?php if($row["bank_sort"] == $t){ echo "selected"; }?>><?php echo $t;?></option>
															<?php
														}
												...
												<td align="center">
													...
													<input type="checkbox" class="status" data-size="mini" data-on-color="success" id="<?php echo $row["bank_ID"];?>" <?php if($row["bank_status"] == 1){ echo "checked";}?>>
													

												</td>
												<td align="center"><a href="<?php echo $page_url;?>?type=edit&id=<?php echo $row["bank_ID"]?>"><i class="fa fa-cog" style="color:#333;font-size:1.4em"></i></a></td>
												<td align="center"><a href="#" class="delete" id="<?php echo $row['bank_ID'];?>"><i class="fa fa-trash-o" style="color:#333;font-size:1.4em"></i></a></td>
											</tr>
