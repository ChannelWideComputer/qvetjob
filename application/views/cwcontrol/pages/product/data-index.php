                     ...
                     foreach ($product as $row) {
                      ...
                      <tr>
                       ...
                       <td align="center"><input class="ChkBox" type="checkbox"
                        name="checkboxlist" value="<?php echo $row["product_ID"];?>"></td>
                        <td align="center"><?php echo $row["product_Name_TH"];?></td>

                        <td align="center"><?php echo DateThai_timestame($row["product_Date"]);?></td>
                        <td align="center">
                      ...
                      <td align="center"><select class="form-control Sort"
                        ...
                        for ($t = 1; $t <= $num; $t ++) {
                         ...
                         <option value="<?php echo $t;?>"
                          <?php if($row["product_Sort"] == $t){ echo "selected"; }?>><?php echo $t;?></option>
                          <?php }?>
                        </select></td>
                        ...
                        <td align="center"><input type="checkbox" class="status"
                          ...
                          id="<?php echo $row["product_ID"];?>"
                          <?php if($row["product_Status"] == 1){ echo "checked";}?>></td>
                          <td align="center"><a
                           href="<?php echo $page_url;?>?type=edit&id=<?php echo $row["product_ID"]?>"><i
                           class="fa fa-cog" style="color: #333; font-size: 1.4em"></i></a></td>
                           <td align="center"><a href="#" class="delete"
                            id="<?php echo $row['product_ID'];?>"><i class="fa fa-trash-o"
