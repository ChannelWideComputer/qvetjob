  ...
  <table class="table table-striped table-bordered table-hover" style="margin-top:10px;" width="100%">
   <thead>
    <tr>
      ...
      <!-- <td width="5%" align="center">หน้าแรก</td> -->
...
?>    
 ...
 <td align="center"><input class="ChkBox" type="checkbox" name="checkboxlist"  value="<?php echo $row["product_ID"];?>"></td> 
 <td align="center"><?php echo $row["product_Name_TH"]?></td>
 <!--<td align="center"><?php echo $row["category_Name_TH"]?></td>-->
 <td align="center"><?php echo DateThai_timestame($row["product_Update"]);?></td>
 <!-- <td align="center">
 <a id="<?php echo $row['product_ID'];?>" class="Home" href="javascript:void(0)">
	<?php
 ...
 <td align="center">
 <select class="form-control Sort" id="<?php echo $row['product_ID'];?>">
     <?php
		
		$query2 = $this->db->get('tb_product');
	...
	?>
<option value="<?php echo $t;?>" <?php if($row["product_Sort"] == $t){ echo "selected"; }?>><?php echo $t;?></option>
<?php
		}
 ...
 <td align="center">
    ...
    <input type="checkbox" class="status" data-size="mini" data-on-color="success" id="<?php echo $row["product_ID"];?>" <?php if($row["product_Status"] == 1){ echo "checked";}?>>
    

 </td>
 <td align="center"><a href="<?php echo $page_url;?>?type=edit&id=<?php echo $row["product_ID"]?>"><i class="fa fa-cog" style="color:#333;font-size:1.4em"></i></a></td>
 <td align="center"><a href="#" class="delete" id="<?php echo $row['product_ID'];?>"><i class="fa fa-trash-o" style="color:#333;font-size:1.4em"></i></a></td>
 </tr>
