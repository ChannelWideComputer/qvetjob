              ...
              <div class="col-lg-12">
                              ...
                              <div class="row">
                                <div class="col-lg-6">  
                                  <div class="form-group">
                                    ...
                                    <textarea name="product_Des_TH" class="form-control ckeditor" rows="3"></textarea>
                           ...
                           ตัวหนังสือ สีแดงคือ VIDEO_ID ของ YouTube <br><br>
                                ...
                                <div class="row">
                                  <div class="col-lg-6">  
                                    <div class="form-group">
                                      <label>รูปภาพปก (555 * 360px)  </label>
                                  ...
                                  <div class="col-lg-6">  
                                    <div class="form-group">
                                      <label>รูปภาพ (555 * 360px)  </label>
                                      <input  type="file" name="product_Images2" class="Images">
                                    </div> 
                                  </div>

                                <!-- <div class="col-lg-6">  
                                  <div class="form-group">
                                    <label>รูปภาพ2 (1140px * 570px) </label>
                                    <input  type="file" name="product_Images2" class="Images">
                                  </div>  
                                </div>
                              </div>
                              ...
                              <div class="row">
                                <div class="col-lg-6">  
                                  <div class="form-group">
                                    <label>รูปภาพ1 (ใช้สำหรับแสดงบน Mobile Version 400px * 225px )  </label>
                                    <input  type="file" name="PHOTO_mobie_min" class="Images">
                                  </div>  
                                </div>
                                <div class="col-lg-6">  
                                  <div class="form-group">
                                    <label>รูปภาพ2 (ใช้สำหรับแสดงบน Mobile Version 400px * 225px )  </label>
                                    <input  type="file" name="PHOTO_mobie_min2" class="Images">
                                  </div>  
                                </div>
                              </div> -->
                           ...
                           <!--       <div class="row">
                            ...
                            <div class="row">
                              <div class="col-lg-6">
                                <div class="form-group">
                                  <label>YouTube</label>
                                  <input type="text" class="form-control" name="product_Clip" id="youtube_Link" value="" >
                                  <p class="help-block">
                                    *การใส่ VDO YouTube ให้นำ VIDEO_ID ของ YouTube มาใส่
                                    ตัวอย่างเช่น http://www.youtube.com/watch?v=<span style="color:#F00;">8FIz_qs66sc</span>
                                    ตัวหนังสือ สีแดงคือ VIDEO_ID ของ YouTube <br><br>
                                    ...
                                    <iframe width="350" height="250" id="myIframe" name="myIframe" src="https://www.youtube.com/embed/"  frameborder="0" allowfullscreen="allowfullscreen"></iframe>
