...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper"> 
			...
			}elseif($this->input->get('type') == "comment"){
				
				$this->load->view('cwcontrol/pages/'.$page.'/comment-data');
			}elseif($this->input->get('type') == "comment_edit"){
				
				$this->load->view('cwcontrol/pages/'.$page.'/comment-edit');	
