                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          ...
                          <button type="submit" class="btn btn-warning">ค้นหา</button>
                             ...
                             <a href="<?php echo $page_url;?>?type=add" class="btn btn-primary">เพิ่มหัวข้อ</a>
                          	 </div> 
  ...
  <table class="table table-striped table-bordered table-hover" style="margin-top:10px;" width="100%">
   <thead>
    <tr>
      ...
      <td width="35%" align="center">ชื่อหัวข้อ</td>
      <td width="5%" align="center">Comment</td>
...
?>    
 ...
 <td align="center"><input class="ChkBox" type="checkbox" name="checkboxlist"  value="<?php echo $row["faq_ID"];?>"></td> 
 <td align="center"><?php echo $row["faq_Ask_TH"]?></td>
 <td align="center"><a  href="<?php echo $page_url;?>?type=comment&id=<?php echo $row["faq_ID"]?>"><span class="fa fa-commenting fa-fw fa-lg"></span></a></td>
 
 <td align="center"><?php echo DateThai_timestame($row["faq_UpDate"]);?></td>
 <td align="center">
 <select class="form-control Sort" id="<?php echo $row['faq_ID'];?>">
     <?php
		
		$query2 = $this->db->get('tb_faq');
	...
	?>
<option value="<?php echo $t;?>" <?php if($row["faq_Sort"] == $t){ echo "selected"; }?>><?php echo $t;?></option>
<?php
		}
 ...
 <td align="center">
    ...
    <input type="checkbox" class="status" data-size="mini" data-on-color="success" id="<?php echo $row["faq_ID"];?>" <?php if($row["faq_Status"] == 1){ echo "checked";}?>>
    

 </td>
 <td align="center"><a href="<?php echo $page_url;?>?type=edit&id=<?php echo $row["faq_ID"]?>"><i class="fa fa-cog" style="color:#333;font-size:1.4em"></i></a></td>
 <td align="center"><a href="#" class="delete" id="<?php echo $row['faq_ID'];?>"><i class="fa fa-trash-o" style="color:#333;font-size:1.4em"></i></a></td>
 </tr>
