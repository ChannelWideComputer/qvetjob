            ...
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                 ...
                 <div class="row">
                   <div class="col-lg-6">  
                      <div class="form-group">
                        <label>ชื่อ (TH)</label>
                        <textarea class="form-control ckeditor" name="news_Name_TH" rows="3" ></textarea>
                ...
                <div class="col-lg-6">  
                  <div class="form-group">
                    <label>ชื่อ (EN)</label>
                    <textarea class="form-control ckeditor" name="news_Name_EN" rows="3" ></textarea>
                        ...
                        <div class="row">
                           <div class="col-lg-6">  
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="photographer_TH" required>
                        ...
                        <div class="col-lg-6">  
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="photographer_EN" required>
                ...
                <div class="row">
                   <div class="col-lg-6">  
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="Stylist_TH" required>
                ...
                <div class="col-lg-6">  
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="Stylist_EN" required>
        ...
        <div class="row">
           <div class="col-lg-6">  
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="location_TH" required>
