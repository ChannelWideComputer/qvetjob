    							...
    							<div class="row">
    								<div class="col-lg-6">  
    									<div class="form-group">
    										<label>ชื่อ (TH)</label>
    										<textarea name="news_Name_TH" class="form-control ckeditor" rows="3"><?php echo $news["news_Name_TH"]?></textarea>
    									</div>  
    								</div>
    								...
    								<div class="col-lg-6">  
    									<div class="form-group">
    										<label>ชื่อ (EN)</label>
    										<textarea name="news_Name_EN" class="form-control ckeditor" rows="3"><?php echo $news["news_Name_EN"]?></textarea>
    									</div>  
    								</div>  
    							</div>
                           			   <!--
                           			 ...
                           			 <div class="row">
                           			 	<div class="col-lg-12">  
                           			 		...
                           			 		<div class="row">
                           			 			<div class="col-lg-6">  
                           			 				<div class="form-group">
                           			 					<label>photographer TH</label>
                           			 					<input type="text" class="form-control" name="photographer_TH" value="<?= $news["photographer_TH"]?>" required>

                           			 				</div>  
                           			 			</div>
                           			 			<div class="col-lg-6">  
                           			 				<div class="form-group">
                           			 					<label>photographer EN</label>
                           			 					<input type="text" class="form-control" name="photographer_EN" value="<?= $news["photographer_EN"]?>"  required>
                           			 		...
                           			 		<div class="row">
                           			 			<div class="col-lg-6">  
                           			 				<div class="form-group">
                           			 					<label>Stylist TH</label>
                           			 					<input type="text" class="form-control" name="Stylist_TH" value="<?= $news["Stylist_TH"]?>"  required>

                           			 				</div>  
                           			 			</div>
                           			 			<div class="col-lg-6">  
                           			 				<div class="form-group">
                           			 					<label>Stylist EN</label>
                           			 					<input type="text" class="form-control" name="Stylist_EN" value="<?= $news["Stylist_EN"]?>"  required>
                           			 		...
                           			 		<div class="row">
                           			 			<div class="col-lg-6">  
                           			 				<div class="form-group">
                           			 					...
                           			 					<input type="text" class="form-control" name="location_TH" value="<?= $news["location_TH"]?>"  required>
                           			 			...
                           			 			<div class="col-lg-6">  
                           			 				<div class="form-group">
                           			 					...
                           			 					<input type="text" class="form-control" name="location_EN" value="<?= $news["location_EN"]?>"  required>
