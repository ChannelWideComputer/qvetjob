              ...
              <div class="row">
                <div class="form-group" >
                  <div class="col-lg-12">
                    ...
                    <input type="text" name="news_Detail_TH" value="<?= $news['news_Detail_TH'] ?>" class="form-control">
                  </div>
                </div>  
              </div>
            ...
            <div id="menu2" class="tab-pane fade in">
              ...
              <div class="row">
                <div class="form-group" >
                  <div class="col-lg-12">
                    <label for="">รายละเอียด</label>
                    <input type="text" name="news_Detail_EN" value="<?= $news['news_Detail_EN'] ?>" class="form-control"> 
                  </div>
                </div>  
              </div> 
