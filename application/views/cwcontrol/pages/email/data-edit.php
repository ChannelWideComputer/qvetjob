                                     ...
                                     <div class="row">
                            			<div class="col-lg-4">  
                                          <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="member_Phone" value="<?php echo $member["member_Phone"]?>">
                                     ...
                                     <div class="row">
                            			<div class="col-lg-4">  
                                          <div id="Email" class="form-group has-feedback">
                                                <label>E-mail</label>
                                                <input type="text" class="form-control" name="member_Email" id="member_Email" value="<?php echo $member["member_Email"]?>">
                                     ...
                                     <div class="row">
                            			<div class="col-lg-4">  
                                          <div id="Pass" class="form-group has-feedback">
                                                ...
                                                <input type="password" class="form-control" name="member_Pass" id="member_Pass" value="<?php echo $member["member_Pass"]?>">
