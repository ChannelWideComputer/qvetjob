...
<form role="form" action="<?php echo base_url('cwcontrol/home/update');?>" method="post" enctype="multipart/form-data">
                                	...
                                	<div class="row">
                            			<div class="col-lg-12">  
                                          <div class="form-group">
                                            ...
                                            <textarea name="about_Detail_TH" class="form-control ckeditor" rows="3"><?php echo $about_Detail_TH;?></textarea>
                                     ...
                                     <div class="row">
                            			<div class="col-lg-12">  
                                          <div class="form-group">
                                            ...
                                            <textarea name="about_Detail_EN" class="form-control ckeditor" rows="3"><?php echo $about_Detail_EN;?></textarea>
