		...
		<div class="col-lg-12" style="margin-top:20px;">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-6">  
							<label>แก้ไขล่าสด : <?php echo $member["member_date_reg"]?></label>
						</div> 
						...
						<div class="col-lg-12">
							...
							<div class="row">
								<div class="col-lg-4">  
									<div id="Email" class="form-group has-feedback">
										...
										<label><?php echo $member["member_Email"]?></label>
							...
							<div class="row">
								<div class="col-lg-4">  
									<div class="form-group">
										...
										<input type="text" class="form-control" name="member_Name" required value="<?php echo $member["member_Name"]?>">
							...
							<!-- <div class="row">
								<div class="col-lg-4">  
									<div class="form-group">
										...
										<input type="text" class="form-control" name="member_Citizen" value="<?php echo $member["member_Citizen"]?>">
							...
							<!-- <div class="row">
								<div class="col-lg-4">  
									<div class="form-group">
										<label>Company</label>
										<input type="text" class="form-control" name="member_Company" value="<?php echo $member["member_Company"]?>">
							...
							<!-- <div class="row">
								<div class="col-lg-4">  
									<div class="form-group">
										<label>Mobile</label>
										<input type="text" class="form-control" name="member_Mobile" value="<?php echo $member["member_Mobile"]?>">
							...
							<div class="row">
								<div class="col-lg-4">  
									<div class="form-group">
										<label>Address</label>
										<textarea name="member_Add" class="form-control" rows="3"><?php echo str_replace("<br>", "", $member["member_Add"])?></textarea>
							...
							<!-- <div class="row">
								<div class="col-lg-4">  
									<div class="form-group">
										...
										<input type="text" class="form-control" name="member_District" value="<?php echo $member["member_District"]?>">
							...
							<!-- <div class="row">
								<div class="col-lg-4">  
									<div class="form-group">
										<label>Country</label>
										<input type="text" class="form-control" name="member_County" value="<?php echo $member["member_County"]?>">
							...
							<!-- <div class="row">
								<div class="col-lg-4">  
									<div class="form-group">
										...
										<input type="text" class="form-control" name="member_Province" value="<?php echo $member["member_Province"]?>">
							...
							<div class="row">
								<div class="col-lg-4">  
									<div class="form-group">
										<label>Message</label>
										<textarea name="member_Message" class="form-control" rows="3"><?php echo str_replace("<br>", "", $member["member_Message"])?></textarea>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#member_Email").change(function(){
			...
			$.post("<?php echo base_url('cwcontrol/'.$page.'/query');?>", { 
				method:'chk_mail',
