           ...
           <div class="tab-content">
            <div id="menu" class="tab-pane fade in active">
              ...
              <div class="row">
                <div class="form-group" >
                  <div class="col-lg-6">
                    <label for="">รายละเอียดย่อ</label>
                    <textarea type="text" name="news_Detail_TH" class="form-control ckeditor"></textarea> 
                  </div>
                  <div class="col-lg-6">
                    <label for="">รายละเอียด</label>
                    <textarea type="text" name="news_Des_TH" class="form-control ckeditor"></textarea> 
                  </div>
                </div>  
              </div>
            ...
            <div id="menu2" class="tab-pane fade in">
              ...
              <div class="row">
                <div class="form-group" >
                  ...
                  <div class="col-lg-6">
                    <label for="">รายละเอียด</label>
                    <textarea type="text" name="news_Des_EN" class="form-control ckeditor"></textarea> 
                  </div>
                </div>  
              </div> 
