					...
					<div class="col-lg-12" style="margin-top:20px;">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-lg-6">  
										Update : <?php echo $row["contact_Update"]?>
									</div> 
										...
										<div class="row">
													<div class="col-lg-6">  
														<div class="form-group">
															<label>Email สำหรับรับข้อมูลติดต่อจากลูกค้า</label>
...
<!--
										...
										<div class="row">
											<div class="col-lg-6">  
												<div class="form-group">
													<label>สถานที่ติดต่อ (TH)</label>
													<textarea name="contact_Detail1_TH" class="form-control ckeditor" rows="4"><?php echo $row["contact_Detail1_TH"]?></textarea>
											...
											<div class="col-lg-6">  
												<div class="form-group">
													<label>สถานที่ติดต่อ (EN)</label>
													<textarea name="contact_Detail1_EN" class="form-control ckeditor" rows="4"><?php echo $row["contact_Detail1_EN"]?></textarea>
												...
												<div class="row">
													<div class="col-lg-6">  
														<div class="form-group">
															...
															<input class="form-control" name="instagram" type="text" value="<?php echo $row["instagram"]?>">
