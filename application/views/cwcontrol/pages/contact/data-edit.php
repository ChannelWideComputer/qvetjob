                            			...
                            			<div class="col-lg-4">
                                          <div class="form-group">
                                             ...
                                             <select class="form-control selectpicker" data-actions-box="true" name="category_ID" required>
												...
												{
												?>
                                                <option value="<?php echo $row["category_ID"]?>" <?php if($contact["category_ID"] == $row["category_ID"]){echo "selected";}?>><?php echo $row["category_Name_TH"]?></option>
                                                <?php }?>
                                            </select>
                                ...
                                <div class="panel-body">
                                			...
                                			<div class="row">
                                				<div class="col-lg-6">  
                                					<div class="form-group">
                                						...
                                						<input type="text" class="form-control" name="contact_Title_TH" required value="<?php echo $contact["contact_Title_TH"]?>">
                                            ...
                                            <div class="row">
                                             <div class="col-lg-6">  
                                              <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="contact_Title_EN" required value="<?php echo $contact["contact_Title_EN"]?>">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">  
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="contact_Detail1_TH"  value="<?php echo $contact["contact_Detail1_TH"]?>" >
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">  
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="contact_Phone"  value="<?php echo $contact["contact_Phone"]?>" >
                                                    </div>  
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">  
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="contact_Detail2_TH"  value="<?php echo $contact["contact_Detail2_TH"]?>" >
                                                    </div>  
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                       <div class="col-lg-6">  
                                          <div class="form-group">
                                             ...
                                             <textarea name="contact_Add_TH" class="form-control" rows="5"><?php echo str_replace("<br>", "", $contact["contact_Add_TH"])?></textarea>
                                        ...
                                        <div class="col-lg-6">  
                                          <div class="form-group">
                                            ...
                                            <textarea name="contact_Des_EN" class="form-control" rows="5"><?php echo str_replace("<br>", "", $contact["contact_Des_EN"])?></textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">  
                                          <div class="form-group">
                                            <label>URL Map</label>
                                            <input type="text" class="form-control" name="contact_Add_EN"  value="<?php echo $contact["contact_Add_EN"]?>" >
                                        </div>  
                                    </div>  
                                </div>
                                    <!-- <div class="row">
                                    	<div class="col-lg-6">  
                                    		<div class="form-group">
                                    			<label>lat</label>
                                    			<input type="text" class="form-control" name="contact_lat" required value="<?php echo $contact["contact_lat"]?>">
                                    	...
                                    	<div class="col-lg-6">  
                                    		<div class="form-group">
                                    			<label>lng</label>
                                    			<input type="text" class="form-control" name="contact_lng" required value="<?php echo $contact["contact_lng"]?>">
                                   ...
                                   <!--  <div class="row">
                            			<div class="col-lg-12">  
                                          <div class="form-group">
                                            ...
                                            <textarea name="contact_Detail_TH" class="form-control ckeditor" rows="3"><?php echo $contact["contact_Detail_TH"]?></textarea>
                                   	...
                                   	<div class="row">
                            			<div class="col-lg-12">  
                                          <div class="form-group">
                                            ...
                                            <textarea name="contact_Detail_EN" class="form-control ckeditor" rows="3"><?php echo $contact["contact_Detail_EN"]?></textarea>
                                    ...
                                    <div class="row">
                                    	<div class="col-lg-5">  
                                    		<div class="form-group">
                                    			...
                                    			<?php
                                    			if($contact["contact_Images_TH"]){
                                    				?>

                                    				<input name="contact_Images_TH" value="<?php echo $contact["contact_Images_TH"]?>" type="hidden">
                                    				<?php
                                    			}
                                    			?>
                                    			...
                                    			<script>
                                    				$('.Images').filer({
                                    					...
                                    					<?php if($contact["contact_Images_TH"]){?>
                                    						files: [
                                    						{
                                    							name: "<?php echo $contact["contact_ID"]?>",
                                    							type: "image",
                                    							file: "<?php echo asset_url()?>upload/contact/<?php echo $contact["contact_Images_TH"]?>"
                                 	...
                                 	<div class="row">
                            			<div class="col-lg-12">  
                                          <div class="form-group" id="aaa">
                                                <label>แกลอรี่ </label>
                                                <input  type="file" name="contact_gallery[]" id="gallery" multiple>
											...
											if(isset($contact["contact_gallery"])){
											foreach ($contact["contact_gallery"] as $row_gallery)					
