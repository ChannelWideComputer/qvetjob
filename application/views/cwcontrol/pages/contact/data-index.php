  ...
  <div class="panel panel-default">
   ...
   <div class="panel-body">
    <div class="row">
      ...
      <br>
      <form class="form-inline" action="<?= base_url('cwcontrol/'.$page.'/update_cus_mail'); ?>" method="post">
        <div class="form-group">
        <label>E-mail ใช้สำหรับรับข้อความ :</label>      
        <input name="id" type="hidden" value="<?php echo $contact['0']["contact_ID"]?>"> 
          <input class="form-control" placeholder="Email สำหรับรับข้อมูลติดต่อจากลูกค้า" name="cus_mail_TH" type="text" value="<?php echo $contact['0']["cus_mail_TH"]?>"  >
        </div> 
...
{  //die();
  ...
  <tr> 
   ...
   <td align="center"><input class="ChkBox" type="checkbox" name="checkboxlist"  value="<?php echo $row["contact_ID"];?>"></td> 
   <td align="center"><?php echo $row["contact_Title_TH"]?></td>
   <!-- <td align="center"><?php echo $row["category_Name_TH"]?></td> -->
   <td align="center"><?php echo DateThai_timestame($row["contact_Update"]);?></td>
 <!-- <td align="center">
 <a id="<?php echo $row['news_ID'];?>" class="Home" href="javascript:void(0)">
  ...
  <td align="center">
    <select class="form-control Sort" id="<?php echo $row['contact_ID'];?>">
     <?php
     
     $query2 = $this->db->order_by('contact_Sort', 'ASC')->get('tb_contact');
     ...
     foreach ($query2->result_array() as $row2)
     {
      ...
      ?>
      <option value="<?php echo $t;?>" <?php if($row["contact_Sort"] == $t){ echo "selected"; }?>><?php echo $t;?></option>
      <?php
    }
...
?>
 ...
 <!-- <td align="center">
  ...
  <td align="center"><a href="<?php echo $page_url;?>?type=edit&id=<?php echo $row["contact_ID"]?>"><i class="fa fa-cog" style="color:#333;font-size:1.4em"></i></a></td>
  <td align="center"><a href="#" class="delete" id="<?php echo $row['contact_ID'];?>"><i class="fa fa-trash-o" style="color:#333;font-size:1.4em"></i></a></td>
</tr>
  ...
  $(document).ready(function(){ 
    ...
    $('.Sort').change(function(){
     ...
     var no = $(this).val();
       ...
       type: 'post',
     data: {id:ID, value:no/*, data_id:cat_id*/ },
     success:function(data){
						//alert(data);
						location.reload();
