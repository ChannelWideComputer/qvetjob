...
?>    
 ...
 <td align="center">
  <select class="form-control Sort" data-id="<?php echo $row['category_ID'] ?>" id="<?php echo $row['news_ID'];?>">
     <?php
    
    $query2 = $this->db->where('category_ID',$row['category_ID'])->order_by('news_Sort', 'ASC')->get('tb_news');
