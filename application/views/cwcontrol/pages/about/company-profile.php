                            ...
                            <button type="submit" class="btn btn-success">บันทึกข้อมูล</button>
                                ...
                                <div class="col-lg-12">
                                	...
                                	<div class="row">
                            			<div class="col-lg-6">  
                                          <div class="form-group">
                                             <label>รายละเอียด ซ้าย (TH)</label>
                            			...
                            			<div class="col-lg-6">  
                                          <div class="form-group">
                                             <label>รายละเอียด ซ้าย (EN)</label>
                                 ...
                                 <div class="row">
                                  <div class="col-lg-6">  
                                          <div class="form-group">
                                             <label>รายละเอียด ขวา (TH)</label>
                                            <textarea name="about_Detail2_TH" class="form-control ckeditor" rows="3"><?php echo $about['about_Detail2_TH']; ?></textarea>
                                  ...
                                  <div class="col-lg-6">  
                                          <div class="form-group">
                                             <label>รายละเอียด ขวา (EN)</label>
                                            <textarea name="about_Detail2_EN" class="form-control ckeditor" rows="3"><?php echo $about['about_Detail2_EN'];?></textarea>
