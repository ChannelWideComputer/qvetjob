...
<div class="col-lg-4">
                    ...
                    <form>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          ...
                          <a href="register-detail-m01.php" style="color: #15c5d2;" title="สมัครสมาชิก"><span><img src="images/icon-05.png" alt="สมัครสมาชิก" title="สมัครสมาชิก" width="18"></span> <b>สมัครสมาชิก</b></a>
                        </div>
                      </div>
                      <br>
                    </form>
                    ...
                    <form>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          ...
                          <a href="register-detail-h.php" style="color: #15c5d2;" title="สมัครสมาชิก"><span><img src="images/icon-05.png" alt="สมัครสมาชิก" title="สมัครสมาชิก" width="18"></span> <b>สมัครสมาชิก</b></a>
                        </div>
                      </div>
                      <br>
                    </form>
        ...
        <div class="col-lg-8">
          <div class="d-box-yellow">
            <center>
              <h2 class="back">ค้นหาสัตวแพทย์/ผู้ช่วย/ตัดขน</h2>
            </center>
            <br>
            <div class="clearfix"></div>
    ...
    <div class="row">
       ...
       <div class="col-lg-6">
            <div class="d-box-white">
              <div class="row">
                 <div class="col-xs-4">
                    <a href="resume-detail.php" title="ผู้ช่วยสัตว์แพทย์"><img class="img-responsive" src="upload/ex.jpg"></a>
                </div>
                <div class="col-xs-8">
                    <div class="row">
                        <a href="resume-detail.php" title="ผู้ช่วยสัตว์แพทย์">
                          <span class="label label-primary" style="border-radius:0;font-weight:100;margin:0;background-color:#333">
            วันที่ 11-05-2559
        </span>
                            <h4 class="gay01">ผู้ช่วยสัตว์แพทย์</h4>

                            <p class="gay02">ปริญญาตรี : สัตวแพทย์มหิดล</p>
                            <p class="gay02">อายุ : 24 ปี</p>
                            <p class="gay02">เพศ : หญิง</p>
                            <p class="purple" style="font-weight: 500;">จ.นนทบุรี</p>
                            <p class="back" style="font-weight: 500;">ตำแหน่งที่เคยทำ :  สัตว์แพทย์</p>
                        </a>
                    </div>
                </div>
            </div>
