...
<head>
  ...
  <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    ...
    <body>
     ...
     <section class="d-padding">
      ...
      <div class="col-lg-9 col-md-9 col-sm-9">
        ...
        <br>
        <form class="wd_contact-from" id="frm_quatation" method="post" action="<?= base_url('register/add') ?>" enctype="multipart/form-data" >
          ...
          <div class="row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-6">
              <div style="text-align:left; margin-bottom:10px;">
               ...
               <input type="file" class="form-control" name="member_Images" value="Browse" style="width:200px;">
             </div>
           ...
           <div class="col-lg-7 col-md-7 col-sm-6">
            ...
            <div class="form-group">
              ...
              <input type="text" name="member_Email" class="form-control" id="email">
              <input type="hidden" name="member_Type" value="Doctor" class="form-control" id="type">
            </div>
            ...
            <div class="form-group">
              ...
              <input type="Password" name="member_Pass" class="form-control" id="email">
            </div>
          ...
          <div class="col-md-2">
           <div class="form-group">
            ...
            <select class="form-control" name="member_title" id="sel1">
        ...
        <div class="col-md-7">
         <div class="form-group">
          ...
          <input type="text" name="member_Name" class="form-control" id="email">
        </div>
      </div>
      ...
      <div class="col-md-3">
       <div class="form-group">
        ...
        <input type="text" name="member_Nickname" class="form-control" id="email">
      </div>
    </div>
    ...
    <div class="col-md-6">
     <div class="form-group">
      ...
      <input class="form-control" type="text" name="member_birthday" id="testdate5">
    </div>
  </div>
  ...
  <div class="col-md-6">
   <div class="form-group">
    ...
    <input type="text" name="member_old" class="form-control" id="email">
  </div>
</div>
...
<div class="col-md-6">
 <div class="form-group">
   ...
   <input type="text" name="idcard" class="form-control" id="email">
 </div>
</div>
...
<div class="col-sm-4">
  <div class="form-group">
    <input type="Subject" name="member_State" class="form-control" id="" placeholder="ถนน">
  </div>
</div>

<div class="col-sm-4">
  <div class="form-group">
    <input type="Subject" name="member_Village" class="form-control" id="" placeholder="หมู่บ้าน">
  </div>
</div>

<div class="col-sm-4">
  <div class="form-group">
    <input type="Subject" name="member_Zip" class="form-control" id="" placeholder="รหัสไปรษณีย์">
  </div>
</div>
...
<div class="col-md-12">
 ...
 <div class="form-group">
  ...
  <div class="checkbox">
    <label><input type="checkbox" name="same" value="1"> ใช้ที่อยู่เดียวกับด้านบน</label>
  </div>
</div>
</div>
...
<div class="col-sm-4">
  <div class="form-group">
    <input type="Subject" name="member_State2" class="form-control" id="" placeholder="ถนน">
  </div>
</div>

<div class="col-sm-4">
  <div class="form-group">
    <input type="Subject" name="member_village2" class="form-control" id="" placeholder="หมู่บ้าน">
  </div>
</div>

<div class="col-sm-4">
  <div class="form-group">
    <input type="Subject" name="member_Zip2" class="form-control" id="" placeholder="รหัสไปรษณีย์">
  </div>
</div>
...
<div class="col-md-6">
 ...
 <input type="text" name="member_Phone" class="form-control" id="email">
</div>
</div>
...
<div class="col-md-6">
 <div class="form-group">
  ...
  <input type="text" name="line_ID" class="form-control" id="email">
</div>
</div>
...
<div class="col-lg-6 col-md-6 col-sm-12">
  <div class="form-group">
    <input type="text" name="study_univer" class="form-control" id="" placeholder="สถาบันการศึกษา">
  </div>
</div>
<div class="col-lg-6 col-md-6 col-sm-12">
  <div class="form-group">
    <input type="text" name="study_branch" class="form-control" id="" placeholder="สาขาวิชา">
  </div>
</div>
<div class="col-lg-6 col-md-6 col-sm-12">
  <div class="form-group">
    <input type="text" name="study_end" class="form-control" id="" placeholder="ปีจบ">
  </div>
</div>
<div class="col-lg-6 col-md-6 col-sm-12">
  <div class="form-group">
    <input type="text" name="study_grade" class="form-control" id="" placeholder="เกรดเฉลี่ย">
  </div>
</div>
...
<div class="col-lg-6 col-md-6 col-sm-12">
  <div class="form-group">
    <input type="text" class="form-control" name="study_univer2" id="" placeholder="สถาบันการศึกษา">
  </div>
</div>
<div class="col-lg-6 col-md-6 col-sm-12">
  <div class="form-group">
    <input type="Subject" class="form-control" name="study_branch2" id="" placeholder="สาขาวิชา">
  </div>
</div>
<div class="col-lg-6 col-md-6 col-sm-12">
  <div class="form-group">
    <input type="Subject" class="form-control" name="study_end2" id="" placeholder="ปีจบ">
  </div>
</div>
<div class="col-lg-6 col-md-6 col-sm-12">
  <div class="checkbox">
    <label><input type="checkbox" name="ecducation" value="1"> กำลังศึกษา</label>
  </div>
</div>
<div class="clearfix"></div>
<div class="col-lg-6 col-md-6 col-sm-12">
  <div class="form-group">
    <input type="Subject" name="study_grade2" class="form-control" id="" placeholder="เกรดเฉลี่ย">
  </div>
</div>
<div class="col-lg-12 col-md-12 col-sm-12">
...
<div class="col-lg-4 col-md-4 col-sm-12">
  <div class="form-group">
    <input type="Subject" name="work_work" class="form-control" id="" placeholder="อาชีพ">
  </div>
</div>
<div class="col-lg-4 col-md-4 col-sm-12">
  <div class="form-group">
    <input type="Subject" name="work_location" class="form-control" id="" placeholder="สถานที่">
  </div>
</div>
<div class="col-lg-4 col-md-4 col-sm-12">
  <div class="form-group">
...
<div class="col-lg-6 col-md-6 col-sm-12">
  ...
  <input class="form-control" type="text" name="work_start" name="testdate5" id="testdate6" >
</div>
</div>
<div class="col-lg-6 col-md-6 col-sm-12">
  <div class="form-group">
    ...
    <input class="form-control" type="text" name="work_end" id="testdate7">
  </div>
</div>
<div class="col-lg-12 col-md-12 col-sm-12">
  <button type="submit" class="button01 btn btn-info" style="padding:6px 25px; margin-top:0px;">
 ...
 <div class="col-lg-12">
  ...
  <div class="checkbox">
    <label><input type="checkbox" name="gt" value="1">ตรวจรักษาโรคทั่วไป</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="st" value="1">เย็บแผล</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="cpr" value="1">CPR</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="endo" value="1">สอดท่อEndo, แทงเส้น</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="slt" value="1">ผ่าตัดทำหมัน หมา แมว ตัวผู้ ตัวเมีย</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="sllt" value="1">ขูดหินปูน</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="gbs" value="1">ผ่าตัดกระเพาะปัสสาวะ นิ่ว</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="cpc" value="1">Cryptorchid</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="remove" value="1">remove mass แบบง่าย</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="ht" value="1">ผ่าตัดมดลูกอัดเสบ</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="eye" value="1">ศัลกรรมตาแบบง่าย (Third eyelid flap, Conjunctival flap)</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="caesar" value="1">ผ่าคลอด</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="dh" value="1">กระบังลมฉีกขาด</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="chest" value="1">ผ่าตัดช่องอกทะลุ</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="mrm" value="1">ผ่าเลาะเต้านม</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="gtw" value="1">ผ่าตัดกระเพาะบิด</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="eyeball" value="1">ควักตา</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="cl" value="1">ตัดขา</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="bs" value="1">ผ่าตัดกระดูก</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="itc" value="1">ตัดต่อลำไส้</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="pm" value="1">Pancreatic mass</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="mam" value="1">Mass ในช่องท้อง หรือ ช่องอก</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="transgender" value="1">แปลงเพศ</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="ventilators" value="1">ใช้เครื่อง ventilators เป็น</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="at" value="1">วางยาสลบ</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="bc" value="1">เคยใช้เครื่องตรวจเลือด Biood chem</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="cbc" value="1">เคยใช้เครื่องตรวจเลือด CBC</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="x_ray" value="1">เคยใช้เครื่อง X-ray</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="ultra" value="1">เคยใช้เครื่อง Ultrasound</label>
  </div>
  <div class="checkbox form-inline">
    <label><input type="checkbox" name="ss" value="1">เฉพาะทาง: <input type="text" class="form-control" name="ssdetail" id="email"></label>
  </div>
  <div class="checkbox form-inline">
    <label><input type="checkbox" name="other" value="1">ความสามารภเพิ่มเติม: <span class="red">(ยิ่งเยอะยิ่งเพื่มโอกาสสำหรับคุณ)</span></label>
  </div>
  <textarea class="form-control d-margin" id="message" name="otherdetail" placeholder="" style="height:150px;"></textarea>
  ...
  <table class="table-res table table-bordered table-striped text_time01" cellpadding="0" cellspacing="1" >
    ...
    <tbody>
      <tr>
        ...
        <td class="table01" data-label="5"><input type="radio" value="5" name="g1"></td>
        <td class="table01" data-label="4"><input type="radio" value="4" name="g1"></td>
        <td class="table01" data-label="3"><input type="radio" value="3" name="g1"></td>
        <td class="table01" data-label="2"><input type="radio" value="2" name="g1"></td>
        <td class="table01" data-label="1"><input type="radio" value="1" name="g1"></td>
      </tr>
      <tr>
        <td class="table01" style="text-align: left!important;background: #e6e6e6;color: #333;">สื่อสารดี , ใช้คำพูดเป็น</td>
        <td class="table01" data-label="5"><input type="radio" value="5" name="g2"></td>
        <td class="table01" data-label="4"><input type="radio" value="4" name="g2"></td>
        <td class="table01" data-label="3"><input type="radio" value="3" name="g2"></td>
        <td class="table01" data-label="2"><input type="radio" value="2" name="g2"></td>
        <td class="table01" data-label="1"><input type="radio" value="1" name="g2"></td>
      </tr>
      <tr>
        <td class="table01" style="text-align: left!important;background: #e6e6e6;color: #333;">การใช้ภาษาอังกฤษ</td>
        <td class="table01" data-label="5"><input type="radio" value="5" name="g3"></td>
        <td class="table01" data-label="4"><input type="radio" value="4" name="g3"></td>
        <td class="table01" data-label="3"><input type="radio" value="3" name="g3"></td>
        <td class="table01" data-label="2"><input type="radio" value="2" name="g3"></td>
        <td class="table01" data-label="1"><input type="radio" value="1" name="g3"></td>
      </tr>
      <tr>
        <td class="table01" style="text-align: left!important;background: #e6e6e6;color: #333;">แก้ปัญหาเฉพาะหน้าได้</td>
        <td class="table01" data-label="5"><input type="radio" value="5" name="g4"></td>
        <td class="table01" data-label="4"><input type="radio" value="4" name="g4"></td>
        <td class="table01" data-label="3"><input type="radio" value="3" name="g4"></td>
        <td class="table01" data-label="2"><input type="radio" value="2" name="g4"></td>
        <td class="table01" data-label="1"><input type="radio" value="1" name="g4"></td>
      </tr>
      <tr>
        <td class="table01" style="text-align: left!important;background: #e6e6e6;color: #333;">ความรู้วิชาการ</td>
        <td class="table01" data-label="5"><input type="radio" value="5" name="g5"></td>
        <td class="table01" data-label="4"><input type="radio" value="4" name="g5"></td>
        <td class="table01" data-label="3"><input type="radio" value="3" name="g5"></td>
        <td class="table01" data-label="2"><input type="radio" value="2" name="g5"></td>
        <td class="table01" data-label="1"><input type="radio" value="1" name="g5"></td>
      </tr>
      <tr>
        <td class="table01" style="text-align: left!important;background: #e6e6e6;color: #333;">ละเอียดรอบคอบ</td>
        <td class="table01" data-label="5"><input type="radio" value="5" name="g6"></td>
        <td class="table01" data-label="4"><input type="radio" value="4" name="g6"></td>
        <td class="table01" data-label="3"><input type="radio" value="3" name="g6"></td>
        <td class="table01" data-label="2"><input type="radio" value="2" name="g6"></td>
        <td class="table01" data-label="1"><input type="radio" value="1" name="g6"></td>
      </tr>
...
<div class="col-lg-12">
  ...
  <div class="checkbox">
    <label><input type="checkbox" name="wlocation1" value="1">ทั่วเขตกรุงเทพ</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="wlocation2" value="1">กรุงเทพและปริมณฑล</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="wlocation3" value="1">ทุกจังหวัดของประเทศไทย</label>
  </div>
  ...
  <div class="checkbox">
    <label><input type="checkbox" name="wlocation5" >จังหวัด(เฉพาะจังหวัด) 
...
<div class="col-lg-12">
  ...
  <div class="radio">
    <label><input type="radio" name="optradio1" value="1" >Part time</label>
  </div>
  <div class="radio">
    <label><input type="radio" name="optradio1" value="2" >Full time</label>
  </div>
  <div class="radio">
    <label><input type="radio" name="optradio1" value="3" >ทั้ง Part time และ Full time</label>
  </div>
</div>
...
<div class="col-lg-12">
  ...
  <div class="checkbox">
    <label><input type="checkbox" name="daywork1" value="1">วันจันทร์</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="daywork2" value="1">วันอังคาร</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="daywork3" value="1">วันพุธ</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="daywork4" value="1">วันพฤหัส</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="daywork5" value="1">วันศุกร์</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="daywork6" value="1">วันเสาร์</label>
  </div>
  <div class="checkbox">
    <label><input type="checkbox" name="daywork7" value="1">วันอาทิตย์</label>
  </div>
...
<div class="col-lg-12">
  ...
  <div class="radio">
    <label><input type="radio" name="sday" value="1">ได้</label>
  </div>
  <div class="radio">
    <label><input type="radio" name="sday" value="2">ไม่ได้</label>
  </div>
  <div class="radio form-inline">
    <label><input type="radio" name="sday" value="3">อื่นๆ: <input type="text" name="sdaydetail" class="form-control" id="email"></label>
  </div>
...
<div class="col-md-12">
 <div class="form-group">
  <textarea class="form-control" name="Message1" required="" style="height: 100px;"></textarea>
</div>
</div>
...
<div class="col-lg-12">
  <div class="form-group">
    ...
    <textarea class="form-control" name="Message2" required="" style="height: 100px;"></textarea>
  </div>
</div>
...
<div class="col-lg-12">
  <div class="form-group">
    ...
    <textarea class="form-control" name="Message3" required="" style="height: 100px;"></textarea>
  </div>
</div>
