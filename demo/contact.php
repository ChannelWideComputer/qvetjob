...
<section class="d-padding" style="background-color: #fdfdfd;">
      <div class="container">
        <div id="map-wrapper"><div id="map"></div></div>
        <div class="clearfix"></div>
        <a href="upload/map.jpg" class="btn btn-danger" data-toggle="lightbox" data-gallery="example-gallery" data-title="Map" style="margin-bottom: 10px;margin-top: 10px;">
