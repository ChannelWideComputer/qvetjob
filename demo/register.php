...
<div class="form-group">
                        <input name="quotation_Company" type="text" class="form-control" placeholder="ชื่อ - นามสกุล / Name - Surname">
                        </div>

<div class="form-group">
                        <input name="quotation_Tel" type="text" class="form-control" placeholder="โทร / Tel">
</div>
<div class="form-group">
                        <input name="quotation_Email" type="email" class="form-control" placeholder="E-mail">
</div>
<div class="form-group">
                        <textarea class="form-control" name="quotation_Address" placeholder="ที่อยู่ / Address" style="height: 100px;"></textarea> 
</div>


<div class="form-group">
                        <input name="quotation_Fax" type="text" class="form-control" placeholder="รหัสผ่าน / Password">
</div>
<div class="form-group">
                        <input name="quotation_Mobile" type="text" class="form-control" placeholder="ยืนยันรหัสผ่าน / Confirm Password  ">
                        </div>


                        <img src="images/pZzc4.png" width="250" alt="" style="margin-bottom: 5px;">
                        ...
                        <div class="p-l" style="margin-bottom:20px;">   
                            <input type="submit" class="btn btn-info" value="Send Confirmation" style="margin-top: 5px;"> <button type="Reset" class="btn btn-info" style="margin-top: 5px;">Reset</button>
                        </div>
                    </form>
                    <div class="clearfix"></div>
                </div> 
