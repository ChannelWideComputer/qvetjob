    ...
    <body>
     ...
     <section id="bg_top" class="big-01" style="background: url('upload/banner.jpg') 50% 66px no-repeat fixed;">
      ...
      <div class="main-banner">
        ...
        <center>
          <h1>ประกาศผลผู้ที่ได้รับรางวัล</h1>
        </center>   
...
<table class="table-res table  table-striped text_time01" cellpadding="0" cellspacing="1" style="background-color:#fff; ">
            <thead>
              <tr>
                ...
                <th style="text-align: center;" width="60%">ผู้ที่ได้รับรางวัล</th>
                <th style="text-align: center;" width="30%">เบอร์โทรศัพท์</th>
            ...
            <tbody>
              <tr>
                ...
                <td class="table01" data-label="ผู้ที่ได้รับรางวัล" style="text-align: center;"><a href="job-view.php" title="ผู้ที่ได้รับรางวัล">นาย xxxx  xxxxxxx</a></td>
                <td class="table01" data-label="เบอร์โทรศัพท์" style="text-align: center;"><a href="job-view.php" title="เบอร์โทรศัพท์">083-xxx-xxxx</a></td>
              ...
              <tr>
                <td class="table01" data-label="ลำดับ" style="text-align: center;">6</td>
                <td class="table01" data-label="ผู้ที่ได้รับรางวัล" style="text-align: center;"><a href="job-view.php" title="ผู้ที่ได้รับรางวัล">นาย xxxx  xxxxxxx</a></td>
                <td class="table01" data-label="เบอร์โทรศัพท์" style="text-align: center;"><a href="job-view.php" title="เบอร์โทรศัพท์">083-xxx-xxxx</a></td>
