      ...
      <div class="col-lg-9 col-md-9 col-sm-9">
        ...
        <form class="wd_contact-from" id="frm_quatation" method="post" action="query_request.php">
          ...
          <div class="row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-6">
              <div style="text-align:left; margin-bottom:10px;">
               ...
               <input type="file" class="form-control sp-form" name="txbFile" value="Browse" style="width:200px;">
             </div>
          ...
          <div class="col-lg-12">
            ...
            <div class="radio">
              <label><input type="radio" name="optradio">ช่างตัดขน</label>
            </div>
            <div class="radio">
              <label><input type="radio" name="optradio">ผู้ช่วยสัตวแพทย์</label>
            </div>
            <div class="radio">
              <label><input type="radio" name="optradio">ทั้ง ช่างตัดขนและผู้ช่วยสัตวแพทย์</label>
            </div>
          </div>
